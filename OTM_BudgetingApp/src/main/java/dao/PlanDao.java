...
public class PlanDao {
    ...
    /**
     * Connects to the database and attempts to find a Plan with an id corresponding to the parameter.
    ...
    /**
     * Connects to the database and attempts to find a Plan with a name corresponding to the parameter.
    ...
    /**
     * Attempts to save create a new Plan in the database.
     * @param name The name of the plan as inputted by the user
     * @param budget The budget of the plan as inputted by the user
     * @return True if plan was successfully saved into the database. False if a plan with the same name already exists.
     * @throws SQLException 
     */
    ...
    /**
     * Deletes a plan from the database with an id corresponding to the parameter.
